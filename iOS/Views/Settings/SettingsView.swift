    ...
    var body: some View {
        Form {
            Section("General") {
                ...
                Picker("Default Route Speed", selection: defaultSpeedBinding) {
            ...
            Section {
                ...
                Text("How smoothly a playing route moves.")
            }
            ...
            Section {
                ...
                Text("Optional. Only used to show your real position on the map.")
            }
